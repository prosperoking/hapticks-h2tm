<template>
  <div class="mt-8">
    ...
    <div class="flex items-center justify-between mt-6">
      ...
      <div class="space-x-2">
        <button v-can="'users.create'" @click="open = true"
          ...
          <tbody>
            <template v-if="state.data.totalDocs">
              <tr v-for="(user) in state.data.docs" :key="user._id">
                ...
                <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                  <button v-can="'users.edit'" class="text-gray-500 hover:text-gray-800" @click="editUser(user)">
                  ...
                  <button v-can="'users.delete'" class="text-gray-500 hover:text-gray-800" @click="confirmUserDelete(user)">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                      stroke="currentColor" class="w-5 h-5">
                      <path stroke-linecap="round" stroke-linejoin="round"

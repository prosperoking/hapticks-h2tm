  ...
  <div class="flex items-center justify-center h-screen px-6 bg-gray-200">
    <div class="w-full max-w-sm p-6 bg-white rounded-md shadow-md">
      <div class="flex items-center justify-center">
          ...
          <span title="Hapticks Terminal Manager and Transaction Monitor" class="mx-2 text-gray-800 text-2xl font-semibold"
            >H2TM</span
          >
      </div>
      ...
      <form class="mt-4" @submit.prevent="login">
        ...
        <div class="flex items-center justify-between mt-4">
          <div>
            <label class="inline-flex items-center">
              <input v-model="rememberMe" type="checkbox" class="text-gray-800 border-gray-200 rounded-md focus:border-gray-800 focus:ring focus:ring-opacity-40 focus:ring-indigo-500" />
          ...
          <div>
            <a
              class="block text-sm text-gray-700 fontme hover:underline"
              href="#"
        ...
        <div class="mt-6">
          <button
            :disabled="loading"
            type="submit"
            class="w-full px-4 py-2 text-sm text-center text-white bg-gray-800 rounded-md disabled:pointer-events-none disabled:opacity-50 focus:outline-none hover:bg-gray-500"
          >
            Sign in
          </button>
        </div>
